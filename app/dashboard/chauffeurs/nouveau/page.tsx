  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-syne font-bold text-text-primary">Nouveau Chauffeur</h1>
          <p className="text-text-secondary text-sm">Ajoutez un conducteur à votre équipe</p>
        </div>
      </div>
