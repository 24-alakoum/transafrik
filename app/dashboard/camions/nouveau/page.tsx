...
import { createCamionAction } from '../actions'
...
export default function NouveauCamionPage() {
  ...
  const onSubmit = (data: CamionInput) => {
    startTransition(async () => {
      const result = await createCamionAction(data)
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-syne font-bold text-text-primary">Nouveau Camion</h1>
          <p className="text-text-secondary text-sm">Ajoutez un véhicule à votre flotte</p>
        </div>
      </div>
